...
import { Button, Checkbox, Form, Input, InputNumber, Select, Skeleton } from 'antd'
...
const OnlinePartnerForm = () => {
  ...
  useEffect(() => {
    ...
    form.setFieldsValue({
      ...
      gametype: selectedOnlinePartner?.gameTypeId || gameTypeId
    })
  }, [selectedOnlinePartner])
    ...
    if (id === '0') {
      dispatch(
        createOnlinePartnerAction({
          ...
          gametypeId: selectedOnlinePartner?.gameTypeId || gameTypeId,
